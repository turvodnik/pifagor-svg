...
- Позволяет выбирать несколько SVG, листать их в приложении, видеть оригинал/результат и одной кнопкой применить текущие настройки ко всем выбранным файлам.
