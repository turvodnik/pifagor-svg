...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.1.9" "$APP_DIR/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 10" "$APP_DIR/Contents/Info.plist"
