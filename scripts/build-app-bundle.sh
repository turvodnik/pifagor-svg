...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.1.8" "$APP_DIR/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 9" "$APP_DIR/Contents/Info.plist"
