...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.1.5" "$APP_DIR/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 6" "$APP_DIR/Contents/Info.plist"
